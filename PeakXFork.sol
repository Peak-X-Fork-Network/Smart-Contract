...
/**
   Peak-X Fork Network - Dominate the blockchain with a single infrastructure (XPEAK)
   By scanning all existing blockchains in the market, it enables the development of developable and multi-chain
   supported Smart Contract software and the development of DApp projects. Projects developed with the support
   of Peak-X Fork Network software are compatible with all blockchains in the market.

   Why is Peak-X Fork Network Important?
   When project developers, Smart Contract software developers or Start-up community projects start/develop a
   project in the crypto money industry, which blockchain should they use, which smart contracts should they use,
   what are the Audit verification reliability indexes, how to provide access to DApp software infrastructures,
   how to correct web3 basics. faced with many problems.

   The Peak-X Fork Network project aims to provide a technological solution to these problems with a single infrastructure.

   Auto-LP: 2% Fee - Project pool strong.
   Marketing: 3% Fee - Marketing and charity.
   www.peakxfork.network
...
contract PeakXFork is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 7700000000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Peak X Fork";
    string private _symbol = "XPEAK";
    ...
    address public charityWallet = 0xB1Becf178154F1D8712b45a02337F698a032BD80;
    ...
    uint256 public numTokensSellToAddToLiquidity = 77000000 * 10**9;
    uint256 public _maxTxAmount = 7700000000 * 10**9;
